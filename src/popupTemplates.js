const appointmentTemplate = `
    ...
    <p class="popup__text">In order to book your session, please send an email to <a href="mailto:#">riseandtrhive@whatever.com</a> specifying the following details:</p>
